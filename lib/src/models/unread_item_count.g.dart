...
part of 'unread_item_count.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UnreadItemCount _$UnreadItemCountFromJson(Map<String, dynamic> json) {
  return UnreadItemCount(
    groupChannelInvitationCount: json['group_channel_invitation_count'] as int,
